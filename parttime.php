...
<head>
    ...
    <title>รายชื่อพนักงานพาร์ทไทม์</title>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="addModalBody">
                    <form action="#" method="post">
                        ...
                        <input type="hidden" name="action" value="addparttime">
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="addModalBody">
                    <form action="#" method="post">
                        ...
                        <input type="hidden" name="action" value="editparttime">
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success btn-md insertFarm" style="float:right;">ยืนยัน</button>
