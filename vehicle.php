                ...
                <table class="table table-bordered table-data  datatables" cellspacing="0">
                    ...
                    ?>
                        ...
                        <tr align="center" name="head_table">
                            ...
                            <td>
                                <button type=button" class="btn btn-warning btn-sm btn_edit tt" vid="<?php echo $VEHICLE[$i]['VID']; ?>" vname="<?php echo $VEHICLE[$i]['VName']; ?>" vstatus="<?php echo $VEHICLE[$i]['statusVehicle']; ?>" vnote="<?php echo $VEHICLE[$i]['comment']; ?>" data-toggle="tooltip" title="แก้ไขข้อมูล">
                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-sm btn_del tt" vid="<?php echo $VEHICLE[$i]['VID']; ?>" vname="<?php echo $VEHICLE[$i]['VName']; ?>" data-toggle="tooltip" title="ลบ">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-xl-5 col-12">
                                ...
                                <input type="radio" style="margin-left:20%" name="status" id="status2" required="" value="ไม่พร้อมใช้งาน"> ไม้พร้อมใช้งาน
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-xl-4 col-12 text-right">
                ...
                <div class="modal-body" id="addModalBody">
                    <form action="#" method="post">
                        <div class="row mb-4">
                            ...
                            <div class="col-xl-5 col-12">
                                <input type="text" class="form-control" name="e_name" id="e_name" required="" placeholder="กรุณากรอกชื่อยานพาหนะ">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-xl-4 col-12 text-right">
                            ...
                            <div class="col-xl-5 col-12">
                                ...
                                พร้อมใช้งาน
                                <input type="radio" style="margin-left:20%" name="e_status" id="e_status2" required="" value="ไม่พร้อมใช้งาน"> ไม้พร้อมใช้งาน
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-xl-4 col-12 text-right">
