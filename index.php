                        ...
                        ?>
                            ...
                            <th class="show<?= $num ?>" style="font-weight: bold; border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                                ...
                                <div class="form-inline">
                                    ...
                                    <select class="form-control js-example-basic-single this th-province" name="province" style="width:220px; font-weight: bold;">
                        ...
                        <tr>
                            ...
                            ?>
                                <td class="show<?= $num ?>" style="border-bottom-width:3px; border-bottom-color: black;">
                                    <input class="form-control numpeople" DID="<?= $k + 1 ?>" SPID="<?= $SERVICE[$i]['SPID'] ?>" id="empcol<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" style="width:90px" type="number" min=0 value="0">
                                </td>
                                <td class="show<?= $num ?>" style="border-bottom-width:3px; border-bottom-color: black;">
