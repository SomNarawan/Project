            ...
            <div align="center" style="margin-top: 20px;">
                <table class="table-bordered border-table">
                    ...
                    <tr align="center" id="head_table" name="head_table">
                        ...
                        ?>
                            <th class="show<?php echo  $num ?>" style="font-weight: bold; border-bottom-width:3px; border-bottom-color: black;">ยอดพนักงาน
                            </th>
                            <th class="show<?php echo  $num ?>" style="font-weight: bold; border-bottom-width:3px; border-bottom-color: black;">จุดที่ตรวจ
                            </th>
                            <th class="show<?php echo  $num ?>" style="font-weight: bold; border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                                <div class="form-inline">
                                    <label>หน่วยที่ <?php echo $k + 1; ?></label>
                                    <input class="form-control th-contact " type="text" placeholder="Checkup Contract number (ไม่เกิน 15 ตัวอักษร)" page="<?php echo  $num; ?>" maxlength="15" style="margin-left:48px; width:447px; font-weight: bold;">
                                </div>
                                <input class="form-control th-company " DID="<?php echo $k + 1; ?>" page="<?php echo  $num; ?>" placeholder="กรอกชื่อบริษัท" type="text" style="width:562px; font-weight: bold;">
                                <div class="form-inline">
                                    <input class="form-control th-time " type="text" placeholder="เวลาออกรถ" page="<?php echo  $num; ?>" style="width:115px; font-weight: bold;">
                                    <input class="form-control th-timeOparetionStart" type="text" placeholder="เวลาเริ่ม" page="<?php echo  $num; ?>" style="width:110px; font-weight: bold;">
                                    -<input class="form-control th-timeOparetionEnd" type="text" placeholder="เวลาสิ้นสุด" page="<?php echo  $num; ?>" style="width:110px; font-weight: bold;">
                                    <select class="form-control js-example-basic-single this th-province" name="province" page="<?php echo  $num; ?>" style="width:220px; font-weight: bold;">
                                ...
                                <div class="form-inline">
                                    ...
                                    <input class="form-control th-date " type="date" page="<?php echo  $num; ?>" style="margin-left:23px; width:447px; font-weight: bold;">
                                </div>
                                <div class="form-inline">
                                    <label for="">เงินทดลองจ่าย&nbsp;</label>
                                    <input class="form-control th-pay " type="number" min="0" page="<?php echo  $num; ?>" style="margin-left:5px; width:195px; font-weight: bold;">&nbsp;
                                    <label for="">รอบตรวจ&nbsp;</label>
                                    <input class="form-control th-round " type="text" page="<?php echo  $num; ?>" style="width:175px; font-weight: bold;">
                                </div>
                            </th>
                        <?php } ?>
                    </tr>
                        ...
                        <tr>
                            ...
                            <?php for ($k = 0; $k < $comp; $k++) {
                                ...
                                if ($SERVICE[$i]['SPID'] == 24) {
                                    ...
                                    <td class="show<?php echo  $num ?>" style="border-bottom-width:3px; border-bottom-color: black;">
                                        <input class="form-control numpeople" DID="<?php echo  $k + 1 ?>" SPID="<?php echo  $SERVICE[$i]['SPID'] ?>" nameSP="<?php echo  $SERVICE[$i]['SPName'] ?>" id="empcol<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" style="width:90px" type="number" min=0 value="0">
                                    </td>
                                    <td class="show<?php echo  $num ?>" style="border-bottom-width:3px; border-bottom-color: black;">
                                ...
                                <td class="show<?php echo  $num ?>" id="col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" style="border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                                    <?php
                                    ...
                                    if ($OPTION[0]['numrow'] != 0) {
                                        ...
                                        <div>
                                            <?php for ($o = 1; $o <= $OPTION[0]['numrow']; $o++) { ?>
                                                <input class="selectOption" type="<?php echo $type; ?>" typeCK="<?php echo  $OPTION[1]['TypeOption'] ?>" DID="<?php echo  $k + 1 ?>" OSID="<?php echo $OPTION[$o]['OSID']; ?>" name="<?php if ($OPTION[$o]['SPID'] == 2) echo "register" . ($k + 1);
                                    ...
                                    <div class="form-inline">
                                        ...
                                        <?php } else if ($SERVICE[$i]['SPID'] == 22) { ?>
                                            <select class="form-control slecetVehicle js-example-basic-single" DID="<?php echo  $k + 1 ?>" VID="0" required style="width:200px;">
                                            ...
                                            <select class="form-control slecetName js-example-basic-single" DID="<?php echo  $k + 1 ?>" SPID="<?php echo  $SERVICE[$i]['SPID'] ?>" PID="0" required style="width:315px;">
                                            ...
                                            <!-- else -->
                                        <?php } else { ?>
                                            <select class="form-control slecetName js-example-basic-single" DID="<?php echo  $k + 1 ?>" SPID="<?php echo  $SERVICE[$i]['SPID'] ?>" PID="0" required style="width:515px;">
                                                <option value="0">เลือกชื่อ</option>
                                                <?php for ($j = 1; $j < $PEOPLE[0]['numrow']; $j++) { ?>
                                                    <option value="<?php echo $PEOPLE[$j]['PID']; ?>">
                                                        <?php echo $PEOPLE[$j]['Title'] . " " . $PEOPLE[$j]['FName'] . " " . $PEOPLE[$j]['LName'] . " (" . $PEOPLE[$j]['NName'] . ")"; ?>
                                        ...
                                        <?php if ($SERVICE[$i]['SPID'] == 15 || $SERVICE[$i]['SPID'] == 16 || $SERVICE[$i]['SPID'] == 21 || $SERVICE[$i]['SPID'] == 24) { ?>
                                        <?php } else { ?>
                                            <button DID="<?php echo  $k + 1 ?>" SPID="<?php echo  $SERVICE[$i]['SPID'] ?>" check="<?php echo $SERVICE[$i]['SPID']; ?>" type="button" class="add-remove set-button btn-plus"><i class="fa fa-plus" style="background: #28a745;"></i></button>
                                        <?php } ?>
                                    </div>
