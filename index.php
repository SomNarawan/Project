                ...
                <tr align="center" id="head_table" name="head_table">
                    ...
                    ?>
                        ...
                        <th class="show<?= $num ?>" style="font-weight: bold; border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                            ...
                            <input class="form-control th-company" placeholder="กรอกชื่อบริษัท" type="text" style="width:355px; font-weight: bold;">
                            <div class="form-inline">
                                <input class="form-control th-time" type="text" placeholder="กรอกเวลาออกรถ" style="width:100px; font-weight: bold;">
                                <input class="form-control th-time" type="text" placeholder="กรอกเวลาตรวจ" style="width:155px; font-weight: bold;">
                    ...
                    <tr>
                        ...
                        ?>
                            ...
                            <td class="show<?= $num ?>" id="col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" style="border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                                ...
                                <input class="form-control note" placeholder="เพิ่มเติม" id="note-col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" type="text" style="width:305px">
                            </td>
