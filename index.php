            ...
            <table class="table-bordered border-table">
                ...
                <tr align="center" id="head_table" name="head_table">
                    ...
                    <th class="show<?= $num ?>"
                        ...
                        <input style="font-weight: bold;" class="form-control th-company" placeholder="กรอกชื่อบริษัท" type="text"
                            style="width:355px">
                        <div class="form-inline">
                            <input class="form-control th-time" type="time" style="width:155px; font-weight: bold;">
                            <select class="form-control js-example-basic-single this th-province" name="province" required
                ...
                <tr>
                    ...
                    <td class="show<?= $num ?>" id="col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>"
                        ...
                        <div class="form-inline">
                            ...
                            <select class="form-control slecetName js-example-basic-single" PID="0" required
                                style="width:155px;">
