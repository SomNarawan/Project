                ...
                <tr align="center" id="head_table" name="head_table">
                    ...
                    ?>
                        ...
                        <th class="show<?= $num ?>" style="border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                            ...
                            <input style="font-weight: bold;" class="form-control th-company" placeholder="กรอกชื่อบริษัท" type="text" style="width:355px">
                            <div class="form-inline">
                                <input class="form-control th-time" type="time" style="width:155px; font-weight: bold;">
                                <select class="form-control js-example-basic-single this th-province" name="province" required style="width:200px; font-weight: bold;">
                                    <option value="0">เลือกจังหวัด</option>
                                    <?php for ($i = 1; $i < $PROVINCE[0]['numrow']; $i++) { ?>
                            ...
                            <td class="show<?= $num ?>" id="col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" style="border-bottom-width:3px; border-bottom-color: black; border-right-width:3px; border-right-color: black;">
                                <div class="form-inline">
                                    <?php if ($SERVICE[$i]['SPID'] == 13) { ?>
                                        <select class="form-control slecetName js-example-basic-single" DID="<?= $k + 1 ?>" SPID="<?= $SERVICE[$i]['SPID'] ?>" PID="0" required style="width:155px;">
                                    ...
                                    <?php } else if ($SERVICE[$i]['SPID'] == 16) { ?>
                                        ...
                                        <select class="form-control slecetName js-example-basic-single" DID="<?= $k + 1 ?>" SPID="<?= $SERVICE[$i]['SPID'] ?>" PID="0" required style="width:105px;">
                                            <option value="0">-</option>
                                            <?php for ($j = 1; $j < $PEOPLE[0]['numrow']; $j++) { ?>
                                                <option value="<?php echo $PEOPLE[$j]['PID']; ?>">
                                                    <?php echo $PEOPLE[$j]['PName']; ?>
                                        ...
                                        <!-- else -->
                                    <?php } else { ?>
                                        <select class="form-control slecetName js-example-basic-single" DID="<?= $k + 1 ?>" SPID="<?= $SERVICE[$i]['SPID'] ?>" PID="0" required style="width:305px;">
                                            <option value="0">-</option>
                                            <?php for ($j = 1; $j < $PEOPLE[0]['numrow']; $j++) { ?>
                                                <option value="<?php echo $PEOPLE[$j]['PID']; ?>">
                                                    <?php echo $PEOPLE[$j]['PName']; ?>
                                ...
                                <input class="form-control" placeholder="เพิ่มเติม" id="note-col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>" type="text" style="width:305px">
                            </td>
