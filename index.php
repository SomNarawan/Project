        ...
        <div class="container-fluid body-web" style="position: absolute; top: 80px;">
            ...
            <div class="row" style="text-align: center;">
                    ...
                    <form action="index.php" method="post">
                        <div class="row">
                            <div class="form-inline" style="margin-left: 10%;">
                                ...
                                <input name="numtime" id="numtime" class="form-control" style="width:70px;"
                                    type="number" min="1" value="<?php echo $numtime; ?>">
                            </div>
                            <div class="form-inline" style="margin-left: 10%;">
                                <label style="width:100px; font-weight: bold;">วันที่ตรวจ</label>
                                <input name="date" id="date" class="form-control" style="width:250px;" type="date"
                                    value="<?php echo $date; ?>">
                            </div>
                ...
                <div class="col-lg-2">
                    ...
                    <button class="btn btn-info set-button" id="submit-data" type="submit"
                    ...
                    <tr align="center" id="head_table" name="head_table">
                        ...
                        <th class="show<?= $num ?>"
                            ...
                            <div class="form-inline">
                                ...
                                <input class="form-control th-contact " type="text" placeholder="set up contact number"
                                    page="<?= $num; ?>" style="margin-left:48px; width:447px; font-weight: bold;">
                            </div>
                            <input class="form-control th-company " DID="<?php echo $k + 1; ?>" page="<?= $num; ?>"
                                placeholder="กรอกชื่อบริษัท" type="text" style="width:562px; font-weight: bold;">
                            <div class="form-inline">
                                <input class="form-control th-time " type="text" placeholder="เวลาออกรถ"
                                    page="<?= $num; ?>" style="width:115px; font-weight: bold;">
                                <input class="form-control th-timeOparetionStart" type="text" placeholder="เวลาเริ่ม"
                                    page="<?= $num; ?>" style="width:110px; font-weight: bold;">
                                -<input class="form-control th-timeOparetionEnd" type="text" placeholder="เวลาสิ้นสุด"
                                    page="<?= $num; ?>" style="width:110px; font-weight: bold;">
                                <select class="form-control js-example-basic-single this th-province" name="province"
                                    page="<?= $num; ?>" style="width:220px; font-weight: bold;">
                            ...
                            <div class="form-inline">
                                ...
                                <input class="form-control th-date " type="date" page="<?= $num; ?>"
                                    style="margin-left:23px; width:447px; font-weight: bold;">
                            </div>
                            <div class="form-inline">
                                <label for="">เงินทดลองจ่าย&nbsp;</label>
                                <input class="form-control th-pay " type="number" min="0" page="<?= $num; ?>"
                                    style="margin-left:5px; width:195px; font-weight: bold;">&nbsp;
                                <label for="">รอบตรวจ&nbsp;</label>
                                <input class="form-control th-round " type="text" page="<?= $num; ?>"
                    ...
                    <tr>
                        ...
                        <td class="show<?= $num ?>" style="border-bottom-width:3px; border-bottom-color: black;">
                            <input class="form-control numpeople" DID="<?= $k + 1 ?>" SPID="<?= $SERVICE[$i]['SPID'] ?>"
                                nameSP="<?= $SERVICE[$i]['SPName'] ?>"
                                id="empcol<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>"
                                style="width:90px" type="number" min=0 value="0">
                        </td>
                        <td class="show<?= $num ?>" style="border-bottom-width:3px; border-bottom-color: black;">
                            <input class="form-control numpoint"
                                id="pointcol<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>"
                                style="width:90px" type="number" min=0 value="0">
                        </td>
                        <?php } ?>
                        ...
                        <td class="show<?= $num ?>" id="col<?php echo $k + 1; ?>row<?php echo $SERVICE[$i]['SPID']; ?>"
                            ...
                            <div>
                                ...
                                <input class="selectOption" type="<?php echo $type; ?>"
                                    typeCK="<?= $OPTION[1]['TypeOption'] ?>" DID="<?= $k + 1 ?>"
                                    OSID="<?php echo $OPTION[$o]['OSID']; ?>"
                                    name="<?php if ($OPTION[$o]['SPID'] == 2) echo "register" . ($k + 1);
                                                                                                                                                                                                                        else echo $OPTION[$o]['OptionName']; ?>"
                                    value="<?php echo $OPTION[$o]['OSID']; ?>">
                                <label
                                    for="<?php echo $OPTION[$o]['OSID']; ?>"><?php echo $OPTION[$o]['OptionName']; ?></label>
                                <?php } ?>
                            </div>
                            <?php } ?>
                            <div class="form-inline">
                                ...
                                <select class="form-control slecetVehicle js-example-basic-single" DID="<?= $k + 1 ?>"
                                    VID="0" required style="width:200px;">
